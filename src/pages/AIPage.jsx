...
function AIHero({ progress, firstLesson, nextLesson, onScrollDown }) {
  ...
  return (
    <section className="ai-course-hero relative h-full min-h-full overflow-hidden px-6 text-center">
      ...
      {/* 模块贡献者标注（右上角） */}
      <a
        href="https://github.com/roclee2692"
        target="_blank"
        rel="noreferrer noopener"
        title="本模块由 roclee2692 贡献"
        className="ai-course-credit absolute right-4 top-4 z-20 inline-flex items-center gap-1.5 rounded-full border border-white/12 bg-black/30 px-3 py-1.5 text-[11px] font-semibold text-[#f7d9ee]/75 backdrop-blur-md transition-colors hover:text-[#f7d9ee] hover:border-white/25"
        style={{ WebkitBackdropFilter: 'blur(8px)' }}
      >
        <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          <path d="M12 .5C5.37.5 0 5.87 0 12.5c0 5.3 3.44 9.8 8.21 11.39.6.11.82-.26.82-.58 0-.29-.01-1.05-.02-2.06-3.34.73-4.04-1.61-4.04-1.61-.55-1.39-1.33-1.76-1.33-1.76-1.09-.74.08-.73.08-.73 1.2.09 1.84 1.24 1.84 1.24 1.07 1.83 2.81 1.3 3.5.99.11-.78.42-1.3.76-1.6-2.67-.3-5.47-1.34-5.47-5.96 0-1.32.47-2.39 1.24-3.23-.13-.3-.54-1.53.12-3.18 0 0 1.01-.32 3.3 1.23a11.5 11.5 0 0 1 6 0c2.29-1.55 3.3-1.23 3.3-1.23.66 1.65.25 2.88.12 3.18.77.84 1.24 1.91 1.24 3.23 0 4.63-2.81 5.65-5.49 5.95.43.37.82 1.1.82 2.22 0 1.6-.02 2.9-.02 3.29 0 .32.22.7.83.58A12 12 0 0 0 24 12.5C24 5.87 18.63.5 12 .5z" />
        </svg>
        <span>模块贡献者 · roclee2692</span>
      </a>
